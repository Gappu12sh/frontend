 ...
 useEffect(()=>{
  const fetchUserRoles=async()=>{
    ...
    try{
      ...
      const response=await axios.get(`${apiUrl}/api/user/selectRole`,{headers:{
        Authorization:`Bearer ${token}`,
      }
    });
    // console.log(response)
    console.log(response.data)
    const roleOptions = response.data.map((role: string) => ({
      value: role, // Role name (e.g., 'admin', 'marketing')
      label: role.charAt(0).toUpperCase() + role.slice(1), // Capitalize role (e.g., 'Admin', 'Marketing')
    }));
    // console.log("role options are",roleOptions)

    setRoles([{ value: "Select", label: "Select" }, ...roleOptions]);
    }catch(error){
      // console.log(error)
    }
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-4">
                        <div className="mb-3">
                          ...
                          <input {...register("user_name")} type="text" className="form-control" />
                        </div>
                      </div>
                      <div className="col-md-4">
                        <div className="mb-3">
                          <label className="form-label">Last Name</label>
                          <input {...register("user_lname")}  type="text" className="form-control" />
                        </div>
                      </div>
                      <div className="col-md-4">
                        <div className="mb-3">
                      ...
                      <div className="col-md-4">
                        <div className="mb-3">
                          <label className="form-label">
                           ...
                           <input value={orgName} {...register("organization_name")} type="text" className="form-control" />
                        </div>
                      </div>
                      <div className="col-md-4">
                        <div className="mb-3">
                          <label className="form-label">Email</label>
                          <input {...register("user_email")} type="text" className="form-control" />
                        </div>
                      </div>
                      <div className="col-md-4">
                        <div className="mb-3">
                          ...
                          <input type="text" {...register("user_mobile")} className="form-control" />
                        </div>
                      </div>
                      <div className="col-md-4">
                        <div className="mb-3">
                          ...
                          <input {...register("user_alt_mobile")} type="text" className="form-control" />
                        </div>
                      </div>
                      <div className="col-md-4">
                        <div className="mb-3">
                      ...
                      <div className="col-md-4">
                        ...
                        <div className="mb-3">
                          ...
                          <input {...register("user_address")} type="text" className="form-control" />
                        </div>
                      </div>
